...
export const horizontalMenuItems = [
    new Menu (1, 'POČETNA', '/', null, null, false, 0),
    new Menu (2, 'NEKRETNINE', '/properties', null, null, false, 0),
    /*new Menu (40, 'STRANICE', null, null, null, true, 0),
    new Menu (41, 'AGENTI', '/agents', null, null, false, 40),
    ...
    new Menu (46, 'MARKETING', '/pricing', null, null, false, 0),
    ...
    new Menu (60, 'O NAMA', '/about', null, null, false, 0),
    new Menu (70, 'KONTAKT', '/contact', null, null, false, 0),
